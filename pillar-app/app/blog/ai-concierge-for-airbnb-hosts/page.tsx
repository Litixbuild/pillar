    ...
    <FeaturePageLayout>
      ...
      <article style={{ padding: 'clamp(40px, 6vw, 64px) clamp(16px, 4vw, 40px)', maxWidth: 720, margin: '0 auto' }}>
        <div style={{ fontSize: 'clamp(14px, 1.8vw, 15.5px)', lineHeight: 1.82, color: 'var(--b-muted)' }}>
          ...
          <p style={{ marginBottom: 24 }}>
            An AI concierge is not a replacement for a <Link href="/platform/qr-portal" style={{ color: 'var(--b-accent)', textDecoration: 'none', borderBottom: '1px solid var(--b-ring)' }}>QR guest portal</Link> — it lives inside one. The portal handles the static, structured information. The concierge handles everything conversational that the static guide cannot anticipate. Together, almost the entire range of guest questions gets answered without reaching your phone.
          </p>
