    ...
    <FeaturePageLayout>
      ...
      <article style={{ padding: 'clamp(40px, 6vw, 64px) clamp(16px, 4vw, 40px)', maxWidth: 720, margin: '0 auto' }}>
        <div style={{ fontSize: 'clamp(14px, 1.8vw, 15.5px)', lineHeight: 1.82, color: 'var(--b-muted)' }}>
          ...
          <p style={{ marginBottom: 24 }}>
            A proper maintenance reporting flow gives guests a low-friction way to submit a request — through the same <Link href="/platform/qr-portal" style={{ color: 'var(--b-accent)', textDecoration: 'none', borderBottom: '1px solid var(--b-ring)' }}>QR portal</Link> they already use for WiFi and house rules — with three things built in:
          </p>
          ...
          <p style={{ marginBottom: 24 }}>
            The categorization step matters more than it looks. A plumbing issue and a WiFi issue need to go to completely different people. <Link href="/platform/work-orders" style={{ color: 'var(--b-accent)', textDecoration: 'none', borderBottom: '1px solid var(--b-ring)' }}>Smart routing</Link> means you are not the single point of failure between a guest's report and the person who can actually fix it.
          </p>
      ...
      <section style={{ padding: 'clamp(40px, 6vw, 56px) clamp(16px, 4vw, 40px)', maxWidth: 720, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          <Link href="/blog/vacation-rental-damage-claim-guide" style={{ textDecoration: 'none', color: 'var(--b-muted)', fontSize: 14, lineHeight: 1.5 }}>
