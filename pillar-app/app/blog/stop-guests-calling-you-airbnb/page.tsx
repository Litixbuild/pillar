      ...
      <article style={{ padding: 'clamp(40px, 6vw, 64px) clamp(16px, 4vw, 40px)', maxWidth: 720, margin: '0 auto' }}>
        <div style={{ fontSize: 'clamp(14px, 1.8vw, 15.5px)', lineHeight: 1.82, color: 'var(--b-muted)' }}>
          ...
          <p style={{ marginBottom: 36 }}>
            This is where an <Link href="/platform/ai-concierge" style={{ color: 'var(--b-accent)', textDecoration: 'none', borderBottom: '1px solid var(--b-ring)' }}>AI concierge inside the portal</Link> changes the math. Guests can ask in plain language and get a useful, specific answer immediately — at 2am, without you ever seeing the message. The call that would have woken you up simply does not happen, because the guest never needed to make it.
          </p>
